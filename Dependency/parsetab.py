...
_lr_productions = [
  ...
  ('create_patient -> ID PERIOD CREATE LP RP','create_patient',5,'p_create_patient','care_parse.py',54),
  ('add_conditions -> AILMENT LP ID RP PERIOD ADD LP ID RP','add_conditions',9,'p_add_conditions','care_parse.py',61),
  ('add_symptoms -> ID PERIOD HAS LP ID RP','add_symptoms',6,'p_add_symptoms','care_parse.py',68),
  ('list_symptoms -> ID PERIOD LIST LP RP','list_symptoms',5,'p_list_symptoms','care_parse.py',75),
  ('remove_patient -> ID PERIOD REMOVE LP RP','remove_patient',5,'p_remove_patient','care_parse.py',82),
  ('diagnose_patient -> ID PERIOD DIAGNOSE LP RP','diagnose_patient',5,'p_diagnose_patient','care_parse.py',89),
  ('specific_diagnose -> ID PERIOD AILMENT LP ID RP PERIOD DIAGNOSE LP RP','specific_diagnose',10,'p_specific_diagnose','care_parse.py',96),
  ('queue -> ID LP ID RP','queue',4,'p_queue','care_parse.py',103),
  ('attend -> ID LP RP','attend',3,'p_attend','care_parse.py',110),
]
